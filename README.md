...
Tips: val_dataset is the first dataset in "--data_test", and the trainer saves the best model on val_datatest of the first scale factor .

Such as:

```
python main.py --model model_name --data_test DIV2K+B100 --data_range 1-800/801-810 --scale 2+3+4 --patch_size 32 --batch_size 16 --save save_dir --n_GPUs 2 --reset
```
...
- get_lr() V2: I have fix the resume bug, and this problem is also fixed.
